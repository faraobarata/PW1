  ...
  if (userid !== 'signin' && userid !== 'signup') {
    ...
    if (userid === 'signin') {
      ...
      console.log('Usuário entrou em users/signin')
        ...
        res.render('signup', { title: 'Sign Up' , content: "No link, coloque um nome junto do users. Por exemplo <b>/users/Pedro Conde</b>, a estrutura é <b>http://localhost:PORTA/users/NOME</b>"});
        res.send
