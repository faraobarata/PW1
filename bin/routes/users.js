  ...
  if (userid !== 'signin' && userid !== 'signup') {
    ...
    if (userid === 'signin') {
      ...
      console.log('Usuário entrou em users/signin')
        ...
        res.render('other', { title: 'Sign Up' , content: "No link, coloque um nome junto do users. Por exemplo <b>/users/Pedro de Almeida</b>, a estrutura é <b>http://localhost:PORTA/users/NOME</b>"});
        res.send
